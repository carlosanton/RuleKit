...
namespace RuleKit
{
    ...
    {
        private const string DefaultErrorMessage = "The field {0} must be less than or equal to {1}.";
        ...
        public LessThanOrEqualToAttribute(string otherProperty) : base(DefaultErrorMessage)
        {
        ...
        {
            return PropertyComparisonValidator.Validate(value, validationContext, OtherProperty, PropertyComparisonOperator.LessThanOrEqualTo, this);
        }
    }
}
