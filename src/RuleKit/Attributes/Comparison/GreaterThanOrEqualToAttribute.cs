...
namespace RuleKit
{
    ...
    {
        private const string DefaultErrorMessage = "The field {0} must be greater than or equal to {1}.";
        ...
        public GreaterThanOrEqualToAttribute(string otherProperty) : base(DefaultErrorMessage)
        {
        ...
        {
            return PropertyComparisonValidator.Validate(value, validationContext, OtherProperty, PropertyComparisonOperator.GreaterThanOrEqualTo, this);
        }
    }
}
