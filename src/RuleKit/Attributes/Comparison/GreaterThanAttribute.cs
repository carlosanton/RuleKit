...
namespace RuleKit
{
    ...
    {
        private const string DefaultErrorMessage = "The field {0} must be greater than {1}.";
        ...
        public GreaterThanAttribute(string otherProperty) : base(DefaultErrorMessage)
        {
        ...
        {
            return PropertyComparisonValidator.Validate(value, validationContext, OtherProperty, PropertyComparisonOperator.GreaterThan, this);
        }
    }
}
